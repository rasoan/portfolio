    ...
    profilePage: {
        ...
        essentialInformationAboutMe: [
            ...
            },
            {
                ...
                description: "сразу готов, желательно начать с удалённого варианта, так как боюсь потерять эту работу если вас не устроят мои умения и навыки, но рассмотрю все варианты",
            },
            {
